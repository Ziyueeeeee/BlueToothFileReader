...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "BluetoothSource"; // <---- update
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//Processor name
		info->processor.name = "BluetoothSource"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<BluetoothSource>);
		break;
	default:
		return -1;
		break;
